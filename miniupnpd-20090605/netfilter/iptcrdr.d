/* $Id: iptcrdr.c,v 1.22 2016/05/24 07:11:21 mt7623 Exp $ */
/* MiniUPnP project
...
syslog(LOG_NOTICE, "delete_rule_and_commit 1.................");
#ifdef IPTABLES_143
...
syslog(LOG_NOTICE, "delete_rule_and_commit 2.................");
	return r;
}
...
delete_redirect_and_filter_rules(unsigned short eport, int proto)
{
	...
	if (h) 
	{
		syslog(LOG_NOTICE, "handle free #1");
		iptc_free(&h);
	}
#endif
	...
	else
	{
		...
		while (strcmp(nat_chain_name[++n], ""))
		{
			...
			if (h) 
			{
				syslog(LOG_NOTICE, "handle free #2");
				iptc_free(&h);
			}
#endif
...
#endif 
			syslog(LOG_NOTICE, "Deleted rules at idx %u %d, %d from %s (%d)", idx, proto, eport, nat_chain_name[n],n);
		} // while
	}
