...
function changeNaviTitleMenuState(id)
{
	...
	if(parent.navi_menu_basic.document.navi_basic_form.image_prefix)
        ...
        else if(id=="extender_setup")
        {
                picon = parent.navi_menu_advance.document.getElementById('extender_picon');
                foldericon = parent.navi_menu_advance.document.getElementById('extender_foldericon');
        }
        else if(id=="extender5g_setup")
        {
                picon = parent.navi_menu_advance.document.getElementById('extender5g_picon');
                foldericon = parent.navi_menu_advance.document.getElementById('extender5g_foldericon');
        }
