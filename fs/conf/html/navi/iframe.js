...
function FillManualAddr( ip, hwaddr)
{
        var F=parent.lan_pcinfo.document.lan_pcinfo_fm;
	var doc=parent.lan_pcinfo.document;

        SetIPDoc( doc, 'manual_ip', ip );
        SetHWDoc(  doc,'manual_hw', hwaddr );
	EnableIPDoc( doc, 'manual_ip');
	EnableHWDoc( doc, 'manual_hw');
