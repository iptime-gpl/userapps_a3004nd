...
struct server_config_t {
	...
	/* ysyoo. 2003.5.29. static lesese */
	char *static_lease_file;
	unsigned long max_static; 	/* maximum number of static leases  */

#ifdef USE_REAL_IPCLONE
	unsigned int sys_netmask	/* system netmask */;
#endif
};	

extern struct server_config_t server_config;
extern struct dhcpOfferedAddr *leases;
extern struct dhcpOfferedStaticAddr *static_leases;
