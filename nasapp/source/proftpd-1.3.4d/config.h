...
#define PR_BUILD_OPTS " '--host=mipsel-linux' '--target=mipsel-linux' '--build=i686-pc-linux' 'CFLAGS=-I/home/mt7621/userapps/nasapp/include -DUSE_IPTIME_WELCOME -DHAVE_LC_MESSAGES -DEFM_ROUTER_PATCH -DEFM_MT7621_PATCH -D_REENTRANT -fPIC' 'LDFLAGS=-L/home/mt7621/userapps/nasapp/lib -liconv' '--sbindir=/sbin' '--sharedstatedir=/usr/share' '--localstatedir=/var/run' '--sysconfdir=/etc' '--enable-autoshadow' '--disable-cap' '--disable-auth-file' '--disable-auth-pam' '--enable-nls' '--with-modules=mod_codeconv:mod_df' '--prefix=/home/mt7621/userapps/nasapp/source/proftpd-1.3.4d/install' 'build_alias=i686-pc-linux' 'host_alias=mipsel-linux' 'target_alias=mipsel-linux' 'CC=mipsel-linux-gcc'"

/* Define to be the build CFLAGS.  */
#define PR_BUILD_CFLAGS "-I/home/mt7621/userapps/nasapp/include -DUSE_IPTIME_WELCOME -DHAVE_LC_MESSAGES -DEFM_ROUTER_PATCH -DEFM_MT7621_PATCH -D_REENTRANT -fPIC -Wall"

/* Define to be the build LDLAGS.  */
#define PR_BUILD_LDFLAGS "-L$(top_srcdir)/lib -L/home/mt7621/userapps/nasapp/lib -liconv "
...
#define PR_INCLUDE_DIR "/home/mt7621/userapps/nasapp/source/proftpd-1.3.4d/install/include"
#endif /* PR_INCLUDE_DIR */

#ifndef PR_LIBEXEC_DIR
#define PR_LIBEXEC_DIR "/home/mt7621/userapps/nasapp/source/proftpd-1.3.4d/install/libexec"
#endif /* PR_LIBEXEC_DIR */

#ifndef PR_LOCALE_DIR
#define PR_LOCALE_DIR "/home/mt7621/userapps/nasapp/source/proftpd-1.3.4d/install/share/locale"
#endif /* PR_LOCALE_DIR */
