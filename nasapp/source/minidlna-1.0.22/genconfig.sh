#! /bin/sh
# $Id: genconfig.sh,v 1.1.1.1 2011/09/29 02:20:09 mvnas Exp $
# MiniDLNA project
...
[ ! -e "/usr/local/include/sqlite3.h" ] && MISSING="libsqlite3 $MISSING"
[ ! -e "/usr/local/include/jpeglib.h" ] && MISSING="libjpeg $MISSING"
[ ! -e "/usr/local/include/libexif/exif-loader.h" ] && MISSING="libexif $MISSING"
[ ! -e "/usr/local/include/id3tag.h" ] && MISSING="libid3tag $MISSING"
[ ! -e "/usr/local/include/ogg/ogg.h" ] && MISSING="libogg $MISSING"
[ ! -e "/usr/local/include/vorbis/codec.h" ] && MISSING="libvorbis $MISSING"
[ ! -e "/usr/local/include/FLAC/metadata.h" ] && MISSING="libflac $MISSING"
