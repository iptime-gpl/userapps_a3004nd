...
#ifdef EFM_PATCH // remove incomplete uploaded file.
...
static void whine_about_eof(int fd)
{
	...
	if (EFM_original)
	{
		...
		do_unlink(EFM_MAGIC_FILE_DOWNLOAD); // delete magic file.
		do_unlink(EFM_MAGIC_FILE_DOWNLOAD1); // delete magic file.
		do_unlink(EFM_MAGIC_FILE_UPLOAD); // delete magic file.
		do_unlink(EFM_MAGIC_FILE_UPLOAD1); // delete magic file.
	}
#endif // EFM_PATCH
