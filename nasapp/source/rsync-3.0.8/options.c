...
#ifdef EFM_PATCH
  {"exp",             0,  POPT_ARG_NONE,   0, OPT_EXP, 0, 0 },
  {"cnp",             0,  POPT_ARG_NONE,   0, OPT_CNP, 0, 0 },
#endif // EFM_PATCH
...
static struct poptOption long_daemon_options[] = {
  /* longName, shortName, argInfo, argPtr, value, descrip, argDesc */
#ifdef EFM_PATCH
  {"server_id",        0,  POPT_ARG_STRING, &EFM_Server_id, 0, 0, 0 },
#endif
#if defined EFM_PATCH || defined EFM_ROUTER_PATCH
  {"original",	       0,  POPT_ARG_NONE,   &EFM_original, 0, 0, 0 },
#endif // EFM_PATCH
  {"address",          0,  POPT_ARG_STRING, &bind_address, 0, 0, 0 },
