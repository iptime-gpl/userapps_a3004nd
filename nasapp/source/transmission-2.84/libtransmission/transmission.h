 ...
 *
 * $Id: transmission.h,v 1.2 2014/11/04 02:11:41 thki81 Exp $
 */
...
#ifdef USE_EFM
#define TR_DEFAULT_PEER_PORT_STR              "52413"
#else
...
#ifdef USE_EFM
int tr_ctorSetMetainfoFromWatchFile( tr_ctor * ctor, const char * filename ); //ysyoo, EFM
#endif
