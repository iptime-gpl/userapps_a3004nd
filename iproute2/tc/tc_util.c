...
int print_rate(char *buf, int len, __u32 rate)
{
	...
	if (tmp >= 1024*1023 && fabs(1024*1024*ceil(tmp/(1024*1024)) - tmp) < 1024)
		snprintf(buf, len, "%gMbit", ceil(tmp/(1024*1024)));
	else if (tmp >= 1024-16 && fabs(1024*ceil(tmp/1024) - tmp) < 16)
		snprintf(buf, len, "%gKbit", ceil(tmp/1024));
	else
...
int print_size(char *buf, int len, __u32 sz)
{
	...
	if (sz >= 1024*1024 && fabs(1024*1024*ceil(tmp/(1024*1024)) - sz) < 1024)
		snprintf(buf, len, "%gMb", ceil(tmp/(1024*1024)));
	else if (sz >= 1024 && fabs(1024*ceil(tmp/1024) - sz) < 16)
		snprintf(buf, len, "%gKb", ceil(tmp/1024));
	else
