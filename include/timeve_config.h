...
#define FLASH_SAVE_OFFSET 0x1f0000 
...
#ifdef USE_SAVE_DIAGFLAG_FLAG
#else
#define FIRSTBOOT_MAGIC_OFFSET 0x1c0000
#endif

#ifdef USE_SAVE_SYSLOG_FLASH
#ifdef USE_EXTRA_SAVE_SECTOR
#define PPPOE_SESSION_SAVE_BASE 0x1d0000
#endif
#else
