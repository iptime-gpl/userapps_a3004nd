...
/*inline int iw_sockets_open(void);
inline void iw_sockets_close(int skfd);
inline int iw_get_ext(int skfd, const char *ifname, int request, struct iwreq *pwrq);
inline int iw_set_ext(int skfd, const char *ifname, int request, struct iwreq *pwrq);
...
inline char *iw_saether_ntop(const struct sockaddr *sap, char* bufp);
int iw_get_range_info(int skfd, const char *ifname, struct iw_range *range);
void setup_pairwise_cipher(unsigned int value, ap_info_t *apinfo);
void setup_authentication_value(unsigned int value, ap_info_t *apinfo);
inline void iw_get_ie_data(unsigned char *iebuf, int buflen, ap_info_t *apinfo);
*/
...
int iw_extract_event_stream(struct stream_descr *stream, struct iw_event *iwe, int we_version);
int iw_freq_to_channel(double freq, const struct iw_range *range);
char *iw_saether_ntop(const struct sockaddr *sap, char* bufp);
int iw_get_range_info(int skfd, const char *ifname, struct iw_range *range);
void setup_pairwise_cipher(unsigned int value, ap_info_t *apinfo);
void setup_authentication_value(unsigned int value, ap_info_t *apinfo);
void iw_get_ie_data(unsigned char *iebuf, int buflen, ap_info_t *apinfo);
int iw_get_priv_info(int skfd, const char *ifname, struct iw_priv_args **ppriv);
/* USER-SIDE ADDED DEFINES END */
