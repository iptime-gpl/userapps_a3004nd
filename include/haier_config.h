...
#define MAX_IMAGE_SIZE (MAX_FLASH_SIZE - MAX_BOOTLOADER_SIZE - FLASH_SAVE_SIZE )
#define MAX_FIRMWARE_SIZE  (MAX_FLASH_SIZE-FLASH_SAVE_SIZE)
#define FLASH_SAVE_OFFSET MAX_FIRMWARE_SIZE


#define EXTERNAL_APPS_OFFSET 0x190000
#define EXTERNAL_APPS_MAX    0x50000
